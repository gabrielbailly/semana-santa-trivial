...
const GAME_SETS = [
  ...
  },
  {
    ...
    title: "Juego 2",
    pairs: [
      { id: "s2p1", personaje: "Jesús al final", frase: '"Todo está cumplido"' },
      { id: "s2p2", personaje: "Jesús al morir", frase: '"Padre, en tus manos encomiendo mi espíritu"' },
      { id: "s2p3", personaje: "Pilato al lavarse las manos", frase: '"Soy inocente de la sangre de este justo"' },
      { id: "s2p4", personaje: "Pedro en la segunda negación", frase: '"No soy de los suyos"' },
      { id: "s2p5", personaje: "Jesús en el arresto", frase: '"Con un beso entregas al Hijo del Hombre"' },
      { id: "s2p6", personaje: "Jesús ante Pilato", frase: '"Mi reino no es de este mundo"' },
      { id: "s2p7", personaje: "Pilato en el pretorio", frase: '"¿Qué es la verdad?"' },
      { id: "s2p8", personaje: "Caifás en el Sanedrín", frase: '"Es reo de muerte"' },
      { id: "s2p9", personaje: "Soldados del pretorio", frase: '"Salve, rey de los judíos"' },
      { id: "s2p10", personaje: "Judas con los sacerdotes", frase: '"¿Qué me queréis dar y yo os lo entregaré?"' },
      { id: "s2p11", personaje: "Pedro tras la pesca", frase: '"Señor, tú lo sabes todo"' },
      { id: "s2p12", personaje: "Jesús en Getsemaní", frase: '"Velad y orad para no caer en tentación"' },
      { id: "s2p13", personaje: "Jesús en oración", frase: '"Hágase tu voluntad"' },
      { id: "s2p14", personaje: "Ángel a las mujeres", frase: '"¿Por qué buscáis entre los muertos al que vive?"' },
      { id: "s2p15", personaje: "María Magdalena al reconocerle", frase: '"¡Rabbuní!"' },
    ],
  },
  {
    id: "set3",
    title: "Juego 3",
    pairs: [
      { id: "s3p1", personaje: "Jesús resucitado a Magdalena", frase: '"No me retengas"' },
      { id: "s3p2", personaje: "Jesús resucitado en Galilea", frase: '"Id por todo el mundo"' },
      { id: "s3p3", personaje: "Jesús ante Caifás", frase: '"Desde ahora veréis al Hijo del Hombre sentado a la derecha del Poder"' },
      { id: "s3p4", personaje: "Criada del patio a Pedro", frase: '"También tú estabas con Jesús el galileo"' },
      { id: "s3p5", personaje: "Jesús en la cena (mandamiento)", frase: '"Amaos unos a otros como yo os he amado"' },
      { id: "s3p6", personaje: "Buen ladrón arrepentido", frase: '"Nosotros lo hemos merecido, este no ha hecho nada malo"' },
      { id: "s3p7", personaje: "Centurión después de la muerte", frase: '"Realmente este era Hijo de Dios"' },
      { id: "s3p8", personaje: "Pilato sobre Jesús", frase: '"No encuentro culpa en este hombre"' },
      { id: "s3p9", personaje: "Jesús sobre su misión", frase: '"Yo para esto he nacido"' },
      { id: "s3p10", personaje: "Jesús a Pedro en la cena", frase: '"No cantará el gallo antes que me niegues tres veces"' },
      { id: "s3p11", personaje: "Jesús al partir el pan", frase: '"Tomad y comed, esto es mi cuerpo"' },
      { id: "s3p12", personaje: "Jesús al dar el cáliz", frase: '"Tomad y bebed, esta es mi sangre"' },
      { id: "s3p13", personaje: "Jesús en la cena (anuncio)", frase: '"Uno de vosotros me va a entregar"' },
      { id: "s3p14", personaje: "Jesús a Pedro (aviso)", frase: '"Antes que cante el gallo me negarás tres veces"' },
      { id: "s3p15", personaje: "Pedro en la cena", frase: '"Aunque todos te abandonen, yo no"' },
    ],
  },
  {
    id: "set4",
    title: "Juego 4",
    pairs: [
      { id: "s4p1", personaje: "Pilato al título de la cruz", frase: '"Lo escrito, escrito está"' },
      { id: "s4p2", personaje: "Multitud ante Pilato", frase: '"¡Crucifícalo!"' },
      { id: "s4p3", personaje: "Jesús a las mujeres de Jerusalén", frase: '"No lloréis por mí"' },
      { id: "s4p4", personaje: "Jesús en el clamor final", frase: '"Dios mío, Dios mío, ¿por qué me has abandonado?"' },
      { id: "s4p5", personaje: "José de Arimatea a Pilato", frase: '"Dame el cuerpo de Jesús"' },
      { id: "s4p6", personaje: "Ángel en la mañana de Pascua", frase: '"No tengáis miedo"' },
      { id: "s4p7", personaje: "Jesús resucitado a las mujeres", frase: '"Alegraos"' },
      { id: "s4p8", personaje: "Jesús resucitado a Tomás", frase: '"Dichosos los que creen sin haber visto"' },
      { id: "s4p9", personaje: "Pedro en el arresto", frase: '"Señor, ¿herimos con la espada?"' },
      { id: "s4p10", personaje: "Siervo del sumo sacerdote", frase: '"¿No te vi yo en el huerto con él?"' },
      { id: "s4p11", personaje: "Sanedrín de madrugada", frase: '"¿Qué necesidad tenemos ya de testigos?"' },
      { id: "s4p12", personaje: "Pilato a Jesús en el juicio", frase: '"¿No oyes de cuántas cosas te acusan?"' },
      { id: "s4p13", personaje: "Jesús en memoria de la cena", frase: '"Haced esto en memoria mía"' },
      { id: "s4p14", personaje: "Jesús en oración sacerdotal", frase: '"Padre, glorifica a tu Hijo"' },
      { id: "s4p15", personaje: "Jesús al Padre por sus discípulos", frase: '"No ruego solo por ellos, sino también por los que crean"' },
    ],
  },
];
